	...
	<section>
		<h1>
			...
			<form action="" method="post">
				...
				<section>
					<h3>メールアドレス</h3>
					<p><?php echo htmlspecialchars($post['mail1']); ?></p>
				</section>
				<section>
					<h3>お問い合わせ内容</h3>
					<p><pre><?php echo htmlspecialchars($post['inquiry']); ?></pre></p>
				</section>

				<div>
					<button class="btn01"><a href="contact.php">内容を変更</a></button>
					<button type="submit" class="btn01">送信</button>
				<div>
